...
/**
 * GET /api/v1/agencies
 * `search` is free text matched against agency name/operational city
 * (see agencyComment.service.js#listAgencies) — optional, so a bare
 * `GET /agencies?page=2` still works for paging through the full
 * directory.
 */
const listAgenciesQuerySchema = Joi.object({
