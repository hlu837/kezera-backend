...
const NOTIFICATION_TYPES = [
  ...
  // "Request Service": someone must act — a new request landed on an
  // Expert/Agency, or an agency just assigned one of its roster to it.
  'service_request_new',
  // "Request Service": a status change the requester (or, on decline,
  // nobody further) needs to see — accepted/declined/completed/cancelled.
