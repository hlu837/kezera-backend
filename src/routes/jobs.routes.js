...
// Reporting summary for the dashboard (total jobs/status breakdown,
// total applicants, applicants today, recent applicants). Registered
// as its own static path rather than a query param on '/my-jobs' so
// the dashboard can fetch just the counts without pulling every job.
router.get('/my-jobs/stats', myJobsStatsHandler);
