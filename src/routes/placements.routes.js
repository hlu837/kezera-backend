...
// "Send Job Request" — employer/agency only (a seeker has no job posting
// to invite themselves onto). Deliberately declared before the
// `/:placementId/...` routes below so the literal path `/invite` can't
// ever be swallowed by the `:placementId` param.
router.post(
  '/invite',
