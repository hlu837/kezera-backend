...
/**
 * GET /api/v1/agencies
 * Public agency directory. Query validated upstream by
 * validateQuery(listAgenciesQuerySchema).
 */
async function listAgenciesHandler(req, res, next) {
  try {
    const result = await agencyCommentService.listAgencies(req.query);
