 ...
 * Reporting summary for the employer/agency dashboard — see
 * jobs.service.js#getMyJobsStats for what's included.
 */
async function myJobsStatsHandler(req, res, next) {
  try {
    const stats = await jobsService.getMyJobsStats(req.user.id);
